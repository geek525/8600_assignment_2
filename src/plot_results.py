...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--title_suffix", type=str, default=None,
                        help="Appended to plot title after a ' | ' separator. "
                             "Example: --title_suffix \"schedule=middle\"")
    parser.add_argument("--filename_suffix", type=str, default=None,
                        help="Inserted before '_generated_vs_ground_truth.png'. "
                             "Example: --filename_suffix \"schedule-middle\"")
...
def build_labels(
    ...
    """Return (plot_title, filename_stem).

    Base title: dataset | D=dim | pred=... | loss=...
    If title_suffix is given, appends " | {title_suffix}".
    If filename_suffix is given, inserts "_{filename_suffix}" before the trailing tag.
    """
    ...
    if filename_suffix is not None:
        stem_parts.append(filename_suffix)
